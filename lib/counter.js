...
class Counter extends Metric {
	constructor(config) {
		...
		this.useCounterValueAsExemplarValue =
			config.useCounterValueAsExemplarValue || false;
	...
	incWithoutExemplar(labels, value) {
		...
		return { labelHash: hash, value: this.hashMap[hash].value };
	}
	...
	incWithExemplar({
		...
		const exemplarValue = this.useCounterValueAsExemplarValue
			? res.value
			: value;

		this.updateExemplar(exemplarLabels, exemplarValue, res.labelHash);
	}
